...
namespace Assets.Scripts.WorldMap
{
    ...
    public class Planet : MonoBehaviour
    {
        ...
        {
            currentSunMovementPattern = (SunMovementPattern)SunMovementPatterns;
        ...
        public void Initialize()
        {
            ...
            // Initial set up for sun movement pattern based on the dropdown
            SetSunMovementPattern();
